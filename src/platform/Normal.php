...
<div id="formdiv" style="display: none">
    <form action="?install2" method="post" onsubmit="return notnull(this);">
        <input name="admin" type="password" placeholder="' . geti18n('EnvironmentsDescription')['admin'] . '" size="' . strlen(geti18n('EnvironmentsDescription')['admin']) . '"><br>
        <input id="submitbtn" type="submit" value="'.geti18n('Submit').'" disabled>
    </form>
</div>
    <script>
    ...
    if ($_GET['install0']) {
        $html .= '<form action="?install1" method="post">
language:<br>';
...
function OnekeyUpate($GitSource = 'Github', $auth = 'qkqpttgf', $project = 'OneSM-php', $branch = 'master')
{
    global $slash;
