...
<div>
    <form action="?Finish&disktag=' . $_GET['disktag'] . '&AddDisk=' . get_class($this) . '" method="post" onsubmit="return notnull(this);">
        <label><input type="radio" name="DriveType" value="Onedrive" checked>' . 'Use Onedrive ' . geti18n(' ') . '</label><br>';
        ...
        <label>
            ...
            <div style="width:100%;margin:0px 35px"><a href="' . $Tenant . '/_layouts/15/sharepoint.aspx" target="_blank">' . geti18n('GetSharepointSiteAddress') . '</a><br>
                <input type="text" name="sharepointSite" style="width:100%;" placeholder="' . geti18n('InputSharepointSiteAddress') . '" onclick="document.getElementById(\'Custom\').checked=\'checked\';">
            </div>
        </label><br>
        ';
            $html .= '
...
<div>
    <form id="form1" action="" method="post" onsubmit="return notnull(this);">
        ...
        <input type="text" name="disktag_add" placeholder="' . geti18n('EnvironmentsDescription')['disktag'] . '" style="width:100%"><br>
        ' . geti18n('DiskName') . ':
        <input type="text" name="diskname" placeholder="' . geti18n('EnvironmentsDescription')['diskname'] . '" style="width:100%"><br>
        <br>
        <div>
            <label><input type="radio" name="Drive_ver" value="Onedrive" onclick="document.getElementById(\'NT_custom\').style.display=\'\';document.getElementById(\'CN_custom\').style.display=\'none\';document.getElementById(\'inputshareurl\').style.display=\'none\';">MS: ' . geti18n('DriveVerMS') . '</label><br>
            ...
            <label><input type="radio" name="Drive_ver" value="OnedriveCN" onclick="document.getElementById(\'CN_custom\').style.display=\'\';document.getElementById(\'NT_custom\').style.display=\'none\';document.getElementById(\'inputshareurl\').style.display=\'none\';">CN: ' . geti18n('DriveVerCN') . '</label><br>
