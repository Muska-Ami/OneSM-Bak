...
<div id="formdiv" style="display: none">
    <form action="?inst-c" method="post" onsubmit="return notnull(this);">
    ...
    if ($_GET['inst']) {
        $html .= '
    <form action="?inst-b" method="post">
language:<br>';
    ...
    $title = 'Install';
    $html = '<a href="?inst">' . getconstStr('ClickInstall') . '</a>, ' . getconstStr('LogintoBind');
    return message($html, $title, 201);
}
